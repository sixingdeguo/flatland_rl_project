...
修改了 malfunction_rate (*1.25) ,min_duration(20->25),min_duration(50->40)三个参数
"""
...
###############################################################
    ...
    data = pd.DataFrame(c)
    # 修改路径！！！
    data.to_csv("../res_save/result_train_malfunctions.csv")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-e", "--evaluation_env_config", help="evaluation config id (eg 0 for Test_0)", default=2, type=int)
